...
| # | Dòng | Nội dung |
|---|---|---|
| 1 | Track + đề | C3 · ScriptScout — Agent tự tìm tài liệu và viết kịch bản video có dẫn nguồn |
| 2 | Job executor (ai · đang ở đâu · làm gì) | Người viết kịch bản đang cần tìm tư liệu và viết kịch bản cho một video bài giảng mới. |
| 3 | Pain một câu (ai – đang làm gì – vướng đâu – hậu quả) | Người duyệt kịch bản khi kiểm tra bài viết không thể biết được các số liệu/ví dụ được lấy từ nguồn nào, dẫn đến nguy cơ duyệt nhầm thông tin lỗi thời hoặc do AI bịa. |
| 4 | 1–2 bằng chứng đầu (số + cách đếm + mã hội thoại/tin nhắn, hoặc khảo sát/phỏng vấn có số người) | - Quét 3 file `transcript-0X-clean.md` trong `vlearn-pack`, đếm được hơn 20 câu (VD: `[T01-003]`, `[T01-016]`) chứa khẳng định khoa học/số liệu nhưng không có trích dẫn nguồn.<br>- Phỏng vấn 3 thành viên Studio Team: 3/3 xác nhận việc kiểm chứng nguồn số liệu hiện tại tốn quá nhiều thời gian. |
| 5 | Lát cắt MỘT CÂU (1 user · 1 việc · 1 quyết định AI · 1 kết quả) | Người viết cần 5 câu mở đầu cho chủ đề X · AI tìm nguồn, đánh giá độ tin cậy và viết 5 câu (có gắn nguồn) · Người duyệt loại 1 nguồn và AI chỉ viết lại những câu bị ảnh hưởng. |
| 6 | AI tự làm đến đâu + 1 dòng lý do · ≥3 willing users ngoài nhóm | - Tự tìm nguồn và viết. Không tự bịa số liệu (phải báo chưa kiểm chứng nếu thiếu nguồn). Lý do: Sai nội dung bài giảng sẽ gây hậu quả nghiêm trọng.<br>- Willing users: Trần Văn Tài, Đức Minh, Vũ Xuân Anh |
| 7 | Phân công có tên | Tô Huy Thông (Evidence & Data mining) · Đinh Văn Bình (Prompt & Retrieval Agent) · Ngô Đinh Minh Nhật (Spec & Eval) · Trần Gia Khánh (UI & Demo) |
